...
const GROUPS: Group[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      { name: "Use cases", where: "The Use cases card; or say what an actor can do", how: "“The customer can place an order and track it” records actors, use cases and who does what on one card that draws its own diagram. Actors link to model components; each use case names the components that realise it, so the impact panel lists the use cases a change touches and the design document gets a Use cases table. Paste a PlantUML use case diagram into import… on the model card to bring one in." },
